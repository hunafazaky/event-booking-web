...
function buildEventForm(input: Partial<CreateEventInput | UpdateEventInput>): FormData {
...
export const eventsApi = {
  ...
  create: (input: CreateEventInput) => api.post<Event>('/events', buildEventForm(input)),
